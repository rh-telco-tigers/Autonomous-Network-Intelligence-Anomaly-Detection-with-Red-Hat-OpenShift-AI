...
- The same bootstrap pattern can be reused on a fresh sandbox cluster; only optional integrations such as Plane, AAP/EDA, and live LLM RCA need later patching.
