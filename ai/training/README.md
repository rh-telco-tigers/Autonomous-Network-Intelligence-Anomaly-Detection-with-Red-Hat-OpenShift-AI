...
- `serving_smoke_check.py` compares `ani-predictive` and `ani-predictive-fs` with shared sample vectors before cutover
...
- endpoint: `http://model-storage-minio.ani-demo-lab.svc.cluster.local:9000`
