...
.PHONY: help kustomize-demo apply-demo-ai-extras check-demo-incident-generators validate-python repo-tree trigger-build-pipeline trigger-anomaly-platform-pipeline trigger-feature-bundle-pipeline trigger-featurestore-pipeline smoke-check-featurestore-serving trigger-incident-release stop-incident-release
...
apply-demo-ai-extras: ## Apply Feature Store, Kafka, and KFP resources not included in the demo overlay
