...
ALLOWED_TRANSITIONS = {
    ...
    ESCALATED: {AWAITING_APPROVAL, APPROVED, VERIFIED, VERIFICATION_FAILED, CLOSED},
    CLOSED: set(),
}
...
REMEDIATION_LIBRARY: Dict[str, Dict[str, Any]] = {
    ...
    AI_PLAYBOOK_GENERATION_ACTION: {
        ...
        "action_mode": "custom",
        "description": "Send the RCA, feature signals, and current remediation context to the external playbook generator so it can return a reviewable Ansible playbook on demand.",
        "risk_level": "low",
        "automation_level": "human_approved",
        ...
        "keywords": ["ansible", "playbook", "automation", "generated", "rca"],
        "metadata": {
            "ai_generated": True,
            "generation_kind": "request",
            "generation_provider": "external generator",
